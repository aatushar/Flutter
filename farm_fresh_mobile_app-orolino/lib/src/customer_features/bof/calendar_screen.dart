      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 10),
            Text("BOF", style: TextStyle(color: Colors.black, fontSize: 20)),
          ],
        ),
        actions: [
          IconButton(
            ...
            Expanded(
              child: ListView(
                children: const [
                  ...
                  EventCard(
                    title: "Live Concert",
                    dateTime: "June 22, 2025 | 5:00 PM",
                    description: "Kawali Live Concert is a soulful musical event showcasing traditional Sufi devotional music performed by passionate qawwals. The concert creates a spiritual and energetic atmosphere, blending rhythmic claps, harmoniums, and powerful vocals.",
                  ),
                ],
              ),
            ),
