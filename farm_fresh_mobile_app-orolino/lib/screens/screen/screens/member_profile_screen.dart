...
class MemberProfileScreen extends StatelessWidget {
  ...
  final String memberName = "Syed Mastafa Jamal";
  final String jobTitle = "Marketing Specialist";
  final String contactEmail = "mostafa@gmail.com";
  final String contactPhone = "+123 456 7890";
  final String location = "Sector 4,Uttara, Dhaka-1230";
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildInfoRow("Contact", "mostafa@gmail.com"),
