...
class _NotificationPageState extends State<NotificationPage> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:Column(
          ...
          children: <Widget>[
            SizedBox(height: 2),
            Text('Notification:',style:TextStyle(fontSize: 22.0,color:Palette.textClrGrayDark,fontWeight: FontWeight.bold)),
                          ...
                          return GestureDetector(
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                'assets/images/icons/new/notification.jpg',
                                                height: 60.0,
                                                fit: BoxFit.cover,
                                              ),
                                              SizedBox(width: 10),
                                              Expanded(child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text(NotificationList[index].title.toString(),style:TextStyle(fontSize: 17,fontWeight: FontWeight.bold)),
                                                  Text(NotificationList[index].shortDesc.toString(),style:TextStyle(fontSize: 14))
                                                ],
                                              )),
                                              SizedBox(width: 10),
                            ...
                            onTap: (){
                              setState(() {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => NotificationDetailViewPage(NotifyID:NotificationList[index].id.toString())),
                                );
                              });
                            },
                          );
  ...
  Future<List<NotificationModel>> GetNotificationData() async {
    ...
    var response = await http.get(Uri.parse("http://165.232.154.198/ccb/api/get-notification-list"));
